                            ...
                            <div className="modal-body modal-body-sub_agile">
                                ...
                                <div className="modal_body_left modal_body_left1">
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <div classNameName="styled-input">
                                ...
                                <div className="container-fluid">
                                    ...
                                    <div className="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                                        <ul className="nav navbar-nav menu__list">
                                            <li className="active">
                                                <Link to="/" className="nav-stylehead">Home
										<span className="sr-only">(current)</span>
                                                </Link>
                                            </li>
                                            <li className="">
                                                <Link className="nav-stylehead" to="/about">About Us</Link>
                                            </li>
										...
										<span className="caret"></span>
                                            ...
                                            <li className="dropdown">
                                                <a href="#" className="dropdown-toggle nav-stylehead"
                                                    data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Household
										<span className="caret"></span>
                                                </a>
                                                <ul className="dropdown-menu multi-column columns-3">
                                                    <div className="agile_inner_drop_nav_info">
                                            ...
                                            <li className="">
                                                <Link className="nav-stylehead" to="/faq">Faqs</Link>
                                            </li>
                                            <li className="dropdown">
                                                <a className="nav-stylehead dropdown-toggle" href="#" data-toggle="dropdown">Pages
										<b className="caret"></b>
                                                </a>
                                            ...
                                            <li className="">
                                                <Link className="nav-stylehead" to="/contact">Contact</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
